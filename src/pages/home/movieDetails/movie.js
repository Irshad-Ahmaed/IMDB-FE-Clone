                ...
                <div className="movie_detailRight">
                    <div className="movie_detailRightTop">
                        ...
                        <div className="movie_rating">
                            {currentMovieDetail ? currentMovieDetail.vote_average : ""} <i className="fas fa-star"></i>
                        ...
                        <div className="movie_releaseDate">{currentMovieDetail ? "Release date: " + currentMovieDetail.release_date + "mins" : ""}</div>
                    ...
                    <div className="movie_detailRightBottom">
                        ...
                        <div className="synopsisDetail">{currentMovieDetail ? currentMovieDetail.overview : ""}</div>
                    </div>
